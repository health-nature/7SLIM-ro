...
$(document).ready(function() {
    ...
    var owl = $('.owl-carousel .owl-stage');
    owl.owlCarousel({
        margin: 10,
        nav: true,
        loop: true,
    ...
    $(".button_order").click(function(e) {
        e.preventDefault();
        $(".pop_up_form").fadeIn().addClass("active");
        setTimeout(function() {
            $(".pop_up_form .container").fadeIn("slow")
        }, 1000);
    });
    $(".form_controls a.close").click(function(e) {
        e.preventDefault();
        $(".pop_up_form, .pop_up_form .container").fadeOut("slow", function() {
            $(".pop_up_form").removeClass("active");
        });
    });
...
function initializeTimer(id_timer) {

    //конфиг конечной даты
    var now_Date = new Date();
    var year_to = now_Date.getFullYear();
    var month_to = now_Date.getMonth();
    var date_to = now_Date.getDate() + 1;
    var hours_to = 0;
    var minutes_to = 0;
    //**************************
    var endDate = new Date(year_to, month_to, date_to, hours_to, minutes_to); //дата конца
    ...
    if (seconds > 0) {
        ...
        setTimePage(hours, minutes, seconds, id_timer);
        ...
        //что-то делать если дата прошла

    }
}

function setTimePage(h, m, s, id_t) {
    var element = $(id_t);
    if (s < 10) s = "0" + s;
    if (m < 10) m = "0" + m;
    if (h < 10) h = "0" + h;
    element.html("<span>" + h + " </span>:<span> " + m + " </span>:<span> " + s + " </span>");
}
